...
module PracticalDeveloper
  class Application < Rails::Application
    ...
    ## Render is asking to disable partial_inserts
    # because of an error caused by the migration 
    # db/migrate/20201019012200_change_email_preference_default_values.rb
